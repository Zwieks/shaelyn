...
(function ($, window, document) {
  ...
  */
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    this.$editor = $('<div>').addClass('emoji-wysiwyg-editor').addClass($($textarea)[0].className).attr("id","firebase-message-input-emoticons");
