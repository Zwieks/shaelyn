<script type="text/javascript">
    $(document).ready(function(e) {
        ...
        $('#modal-chat-new').on('hidden.bs.modal', function () {
            $('#modal-chat-new .firebase-search-chatfriends-results .invite').removeClass('invite');
            $('#search_field_chatfriends').val("");
            $('#new_chatname').val("");
            $('.js-invite-wrapper').show();
            $('#js-creat-chat-confirmation').hide();
            $('#modal-chat-new .firebase-search-chatfriends-results').empty();
            $('#modal-chat-new .detail-members').empty();
        });
