...
<div class="modal-body">
	...
	<div id="js-invite-chatfriend-search">
		...
		<div id="firebase-search-chatfriends-results" class="component-search"></div>
	</div>

	<div class="modal-notification" id="js-creat-chat-confirmation">
...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-primary" id="js-invite-chatfriends">{{ Lang::get('buttons.invite') }}</button>
</div>